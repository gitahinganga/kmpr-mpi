...
public class ValueMap {
	...
	public static final ValueMap PERSON_IDENTIFIER_TYPE = new ValueMap(Arrays.asList(
			...
			new Value(PersonIdentifier.Type.kisumuHdssId, "4"),
			new Value(PersonIdentifier.Type.TELEPHONE_NO, "5"),
			new Value(PersonIdentifier.Type.NATIONAL_ID, "6"),
			new Value(PersonIdentifier.Type.NHIF_NO, "7"),
			new Value(PersonIdentifier.Type.HUDUMA_NO, "8"),
			new Value(PersonIdentifier.Type.PASSPORT_NO, "9"),
			new Value(PersonIdentifier.Type.BIRTH_CERTIFICATE_NO, "10"),
			new Value(PersonIdentifier.Type.BIRTH_NOTIFICATION_NO, "11"),
			new Value(PersonIdentifier.Type.ALIEN_ID, "12"),
			new Value(PersonIdentifier.Type.NEMIS_ID, "13")
	));
